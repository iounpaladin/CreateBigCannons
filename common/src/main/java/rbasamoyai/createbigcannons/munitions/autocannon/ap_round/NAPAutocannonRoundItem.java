...
public class NAPAutocannonRoundItem extends AutocannonRoundItem {

    public NAPAutocannonRoundItem(Properties properties) {
        super(properties);
    }

    @Override
    public AbstractAutocannonProjectile getAutocannonProjectile(ItemStack stack, Level level) {
        return CBCEntityTypes.NAP_AUTOCANNON.create(level);
    }
	@Override
	public EntityType<? extends PropertiesMunitionEntity<? extends AutocannonProjectileProperties>> getEntityType(ItemStack stack) {
		return CBCEntityTypes.NAP_AUTOCANNON.get();
	}
}
